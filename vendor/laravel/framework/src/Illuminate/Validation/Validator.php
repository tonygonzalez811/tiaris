...
class Validator implements MessageProviderInterface {
    ...
    /**
     * Added by me.
     * It's the same as alpha but it also accepts spaces
     *
     * @param $attribute
     * @param $value
     * @return bool
    ...
    {
        return preg_match('/^[\pL\s]+$/u', trim($value));
    }

    /**
     * Added by me.
     * Only allows characters that would be found on a phone number, but doesn't validate the number
     *
     * @param $attribute
     * @param $value
     * @return bool
     */
    protected function validatePhoneChars($attribute, $value)
    {
